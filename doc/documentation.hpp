 ...
 *
 * This is the documentation of the programming project for the exercises in the Lecture 'Databases Implementation Techniques' (DB2) in summer term 2013. You can find general information about the lecture <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2013/">here</a>.
 ...
 * 
 *		The task is to implement compression techniques in our framework. We provide a set of classes as presetting, where you have to include an implementation w.r.t. an interface. You can download the sources <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2013/programming_task/db2_programming_project_SoSe2013.tgz">here</a>. A set of unit tests will help you during the development process to identify errors. The same unit tests will be used at the end of the term to validate your solution. A working implementation is a necessary prerequisite to participate in the exam!
...
All compression techniques are explained in the lecture. You can find the slides <a href="http://wwwiti.cs.uni-magdeburg.de/iti_db/lehre/db2/2013/slides/teil2.pdf">here</a>.
 *
...
Please register your team until the <b>29.04.2013</b> via email to: sebastian.bress@iti.cs.uni-magdeburg.de, subject: DB2-2013 Programmierprojekt Anmeldung. 
Content: For each team member, we need to know the name, matrikel number, and email adress.

Solutions are to be submitted via email to: sebastian.bress@iti.cs.uni-magdeburg.de, subject: DB2-2013 Programmierprojekt Abgabe. The deadline is the 28.06.2013 at 23:59 o'clock. Note that the deadline is strict, there will be <b>no</b> deadline extension.
...
@code
cd db2_programming_project_SoSe2013
make
make documentation
make run
@endcode
